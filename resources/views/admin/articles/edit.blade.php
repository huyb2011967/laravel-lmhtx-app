    ...
    <div class="card card-primary">
        <div class="card-body" style="display: block;">
            <div class="form-group">
                ...
                <input type="text" name="title" id="inputTitle" class="form-control" value="{{$articles->title_article}}">
                @error('title')
            ...
            <div class="form-group">
                ...
                <input type="text" name="subtitle" id="inputSubtitle" class="form-control" value="{{$articles->subtitle_article}}">
                @error('subtitle')
                <div class="text-danger">{{ $message }}</div>
                @enderror
            </div>
            <div class="form-group">
                ...
                <textarea id="inputContent" name="content" class="form-control" rows="4" style="height: 142px;">
            ...
            <div class="form-group">
                ...
                <select class="form-control" name="category">
                    <option value="{{$articles->id_category}}">{{$articles->category->name_category}}</option>
